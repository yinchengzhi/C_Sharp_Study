...
namespace UploadPic
{
    ...
    public partial class UploadPicTest : System.Web.UI.Page
    {
        ...
        protected void PictureShow()
        {
            ...
            string PictureStr = Request.Form["Picture"];
            ...
            if (PictureStr != null)
            {
                ...
                if (!File.Exists("D:\\"+PictureName))
                {
                    FileStream fs = new FileStream("D:\\" + PictureName, FileMode.Create);
                ...
                if (!File.Exists("D:\\" + PictureName + ".txt"))
                {
                    FileStream fs = new FileStream("D:\\" + PictureName + ".txt", FileMode.Create);
